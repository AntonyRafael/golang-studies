...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar outro usuário"))
		return
	}
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel seguir a si mesmo"))
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel deixar de seguir a si mesmo"))
		return
	}
...
// BuscarSeguidores traz os seguidores do usuário
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	senhaSalvaNoDB, erro := repositorio.BuscarSenha(usuarioID)
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoDB, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha antiga não confere"))
		return
	}
